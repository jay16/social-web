...
ActiveRecord::Schema.define(:version => 20120827050452) do
  ...
  add_index "display_messages", ["WID"], :name => "index_display_messages_on_WID", :unique => true
  add_index "display_messages", ["rule_id"], :name => "index_display_messages_on_rule_id", :unique => true
  ...
  add_index "rule_defs", ["AccountID"], :name => "index_rule_defs_on_AccountID", :unique => true
  ...
  create_table "user_friend_followers", :force => true do |t|
    t.integer  "UID",                               :null => false
    t.integer  "source_UID",                        :null => false
    t.integer  "follower_friend_UID",               :null => false
  ...
  add_index "username_selects", ["UID"], :name => "index_username_selects_on_UID", :unique => true
  add_index "username_selects", ["rule_id"], :name => "index_username_selects_on_rule_id", :unique => true
